        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', maxWidth: '850px' }}>
          <div>
            ...
            <p style={{ fontSize: '1.1rem', fontWeight: 500, color: 'var(--color-primary)', marginTop: '0.25rem', opacity: 0.8 }}>
              Backend Systems • Scalable APIs • Authentication • Modern Frontend Architecture
            </p>
          </div>
          
          <p style={{ fontSize: '1.2rem', lineHeight: '1.6', color: 'var(--color-text)', opacity: 0.8 }}>
            Full stack developer with professional software development experience and strong production expertise in 
            designing and maintaining scalable applications using Symfony, Node.js, Vue.js, and Next.js. 
            Focused on secure backend architecture, high-performance APIs, and seamless user experiences.
          </p>
